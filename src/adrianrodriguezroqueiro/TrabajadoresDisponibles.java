...
public class TrabajadoresDisponibles extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableTrabajadores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre y apellidos", "Provincia", "Profesion"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrabajadoresDisponibles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
